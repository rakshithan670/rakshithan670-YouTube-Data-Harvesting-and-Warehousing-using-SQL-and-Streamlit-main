...
api_version = "v3"
api_Key="AIzaSyDHOKDQ0Yk_DW9J1I6uNBEVdfcX6Z54koo"
...
icon=("www.gstatic.com/youtube/img/branding/youtubelogo/svg/youtubelogo.svg")
st.set_page_config(page_title='YouTube Data Harvesting and Warehousing',
                    page_icon=icon,
                    layout='wide',
                    initial_sidebar_state='expanded',
                    menu_items={'About': '''This streamlit application was developed by Rakshitha.
                                Contact_e-mail:rakshithan670@gmail.com'''})
...
if selected == "Home":
    ...
    st.markdown('''Hello! I'm Rakshitha, a BE graduate with a keen interest in Artificial ingtelligence .
                Currently on an exciting journey into the world of Artificial ingtelligence ,
    ...
    st.markdown('#### linkedin:https://www.linkedin.com/in/rakshitha-n-4812841bb/')
    st.markdown('#### Email : rakshithan670@gmail.com')
